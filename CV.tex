...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {ESCP}{}
      {Option E(ntreprenariat)}{Paris, France}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed an AI-powered crawler/scraper to retrieve product data from an ecommerce website using \textbf{FastAPI}, \textbf{LangChain} and \textbf{Google-ADK}, saving over \textbf{2000 hours of workforce} a year}
        \resumeItem{Contributed to a fullstack internal tool, built with \textbf{NextJS}, \textbf{Fastify} and \textbf{GraphQL}, streamlining the sales and merchandising processes, saving \textbf{1500 days of workforce} a year }
...
\section{Technical Skills}
 ...
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{AI Tools}{: Cursor, Claude Code, n8n, Clay}
    }}
 \end{itemize}
